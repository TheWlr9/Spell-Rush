...
public class FireAttack extends AttackObject {
    private static final int ANIMATION_SPEED = GameThread.FRAMES_PER_SECOND / 64;

    private int drawTimer;
    private boolean frame;
    private final int FRIEND_SPRITE_ID_FRAME_1 = R.drawable.fire_attack1;
    private final int FRIEND_SPRITE_ID_FRAME_2 = R.drawable.fire_attack2;
    private final int ENEMY_SPRITE_ID_FRAME_1 = R.drawable.fire_attack_enemy1;
    private final int ENEMY_SPRITE_ID_FRAME_2 = R.drawable.fire_attack_enemy2;
