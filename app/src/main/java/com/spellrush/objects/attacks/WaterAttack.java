...
public class WaterAttack extends AttackObject {
    private static final int ANIMATION_SPEED = GameThread.FRAMES_PER_SECOND / 32;

    private int drawTimer;
    private boolean frame;
    private final int FRIEND_SPRITE_ID_FRAME_1 = R.drawable.water_attack1;
    private final int FRIEND_SPRITE_ID_FRAME_2 = R.drawable.water_attack2;
    private final int ENEMY_SPRITE_ID_FRAME_1 = R.drawable.water_attack_enemy1;
    private final int ENEMY_SPRITE_ID_FRAME_2 = R.drawable.water_attack_enemy2;
